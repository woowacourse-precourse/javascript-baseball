...
describe("Defender", () => {
  test("나(공격수)의 Ball이 425이고 컴퓨터(수비수)의 Ball이 425이면 3스트라이크를 출력", async () => {
  ...
  test("나(공격수)의 Ball이 456이고 컴퓨터(수비수)의 Ball이 425이면 1볼 1스트라이크를 출력", async () => {
    const BALL_GENERATOR = new AutomaticBallGenerator();
