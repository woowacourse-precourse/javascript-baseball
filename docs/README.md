...
## TDD
- [x] 상대방(컴퓨터)의 수가 123일 경우의 테스트 코드 작성
- [x] 상대방(컴퓨터)의 수가 123일 경우의 테스트 코드를 통과하는 코드 작성
- [ ] 상대방(컴퓨터)의 수가 랜덤하게 나오는 테스트 코드 작성
- [ ] 상대방(컴퓨터)의 수가 랜덤하게 나오는 테스트 코드를 통과하는 코드 작성
- [ ] 입력받은 수가 3자리의 수가 아닐 경우를 처리하는 테스트 코드 작성
- [ ] 입력받은 수가 4자리의 수가 아닐 경우를 처리하는 테스트 코드를 통과하는 코드 작성
- [ ] 입력받은 수가 서로 다른 수로 이루어지지 않은 경우를 처리하는 테스트 코드 작성
- [ ] 입력받은 수가 서로 다른 수로 이루어지지 않은 경우를 처리하는 테스트 코드를 통과하는 코드 작성
- [ ] 게임 종료 후 재시작 테스트 코드를 통과하는 코드 작성
