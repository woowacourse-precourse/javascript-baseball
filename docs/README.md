...
- `TDD`와 기능 구현 목록 및 객체 설계를 어떻게 했는지를 [우테코 프리코스 5기 2주차 회고](https://velog.io/@turtle601/%ED%9A%8C%EA%B3%A0-%EC%9A%B0%ED%85%8C%EC%BD%94-%ED%94%84%EB%A6%AC%EC%BD%94%EC%8A%A4-5%EA%B8%B0-2%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A0) 에 자세하게 적었습니다
...
- docs/README.md 기능 구현 목록 설계를 바꿀 때마다 수정본 표시를 하였습니다.
- `커밋`의 경우 각 기능에 맞는 `테스트 코드 작성 - 기능 구현 - 테스트 - 커밋 - docs/README.md에 있는 기능 체크 표시` 순으로 작성하였습니다.
