...
| 번호  | 내용                                    | 제약 조건                                                                                |
|-----|---------------------------------------|--------------------------------------------------------------------------------------|
| 1   | 임의의 3자리 수 만들기                         | 각 자리 수에 겹치는 숫자가 없도록 하기                                                               |
| 2   | 사용자에게 3 자리 수 입력 받기                    | - 게임 성공시까지 반복                                                                        |
| 2-1 | 사용자에게 3 자리 수 입력 받기                    | - 숫자만                                                                                |
| 2-2 | 사용자에게 3 자리 수 입력 받기                    | - 3자리 수                                                                              |
| 2-3 | 사용자에게 3 자리 수 입력 받기                    | - 겹치는 숫자 없음                                                                          |
| 2-4 | 사용자에게 3 자리 수 입력 받기                    | - 잘못된 입력시 프로그램 종료                                                                    |
| 3   | 임의의 3자리 수와 사용자 입력 수 비교 (볼, 스트라이크 카운트) | - 숫자와 위치가 일치하는 경우 '스트라이크'<br/>- 일치하는 숫자지만 위치는 다른 경우 '볼'                              |
| 4   | 게임 결과 출력                              | - 일치하는 숫자가 전혀 없는 경우 '낫싱'                                                             |
| 5   | 게임 시작 멘트 출력                           |                                                                                      |
| 6   | 게임 성공 멘트 출력                           | 게임 결과가 3 스트라이크일 경우 성공                                                                |
| 7   | 게임 성공시 사용자 커맨드 입력 받기                  | 게임 결과가 3 스트라이크일 경우 성공<br/>- 1 입력시 새로운 게임 시작<br/>- 2 입력시 게임 종료<br/>- 그 외의 입력식 프로그램 종료 |
| 8   | 게임 시작                                 |                                                                                      |
| 9   | 게임 종료                                 |                                                                                      |