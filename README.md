...
## ☑️ 기능 구현 체크리스트
☐ 1. 임의의 숫자 3자리를 변수에 저장하는 기능 구현
☐ 2. 사용자의 입력값이 올바른지 확인하는 기능 구현
  ☐ 2-1. 중복된 값을 넣었는지 확인
  ☐ 2-2. 3자리 수 이하이거나 이상인 값을 넣었는지 확인
☐ 3. 결과를 출력하는 기능 구현
  - 3스트라이크가 아닌 경우
  ☐ 3-1. 자리와 숫자가 모두 맞으면 strick
  ☐ 3-2. 숫자만 맞으면 ball
  ☐ 3-3. 모두 맞지 않으면 낫싱
  ☐ 3-4. strick,ball,낫싱의 개수를 출력한다.
  - 3스트라이크일 경우
  ☐ 3-5. 게임을 종료시킨 후 재시작할지 종료할지 확인
  ☐ 3-6. 재시작일 경우 처음(1번)으로 돌아간다.
  ☐ 3-7. 종료일경우 게임을 종료시킨다.
